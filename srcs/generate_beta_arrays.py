...
def generate_beta_arrays(path_i, n_giorni, max_months, overlap, start_date  = '15/03/2020', n_timesteps = None, regions = reg_list):
    n_mesi = n_giorni / 30
    reg_list = ['Abruzzo',
     'Basilicata',
     'Calabria',
    ...
    K_b = 1 / 20 # percentule di timestep per interpolare beta, regola lo smoothing di beta
    ...
    return beta_spline, infetti_SIR
